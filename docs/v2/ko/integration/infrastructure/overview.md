...
| 확장 기능 | 미들웨어 | 기능 |
| --- | --- | --- |
| [Higress](higress.md) | [Higress](https://higress.io/) AI 게이트웨이 | 게이트웨이에서 MCP로 게시된 도구를 Toolkit으로 가져오기 |
| [Nacos](nacos.md) | [Nacos](https://nacos.io/) | A2A AgentCard 레지스트리/디스커버리, 프롬프트 설정 센터, 스킬 저장소 |
| [Scheduler](scheduler.md) | XXL-Job / Quartz | CRON 일정 또는 고정 주기로 Agent 실행 |
