...
| --- | --- | --- |
| [Simple](simple.md) | 자체 관리: 임베딩 + 벡터 스토어 | 직접 벡터 스토어를 가져오는 경우 (PgVector / Milvus / Qdrant / Elasticsearch / in-memory) |
| [Bailian](bailian.md) | Alibaba Cloud Bailian Knowledge Base | Bailian이 호스팅하는 엔터프라이즈 KB 사용 |
| [Dify](dify.md) | Dify dataset | 이미 Dify에서 KB 콘텐츠를 관리하고 있는 경우 |
| [HayStack](haystack.md) | 셀프 호스팅 HayStack RAG | 기존 HayStack 파이프라인 |
| [RAGFlow](ragflow.md) | RAGFlow service | OCR / 지식 그래프가 필요한 복잡한 문서 |
